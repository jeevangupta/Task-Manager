...
SECRET_KEY = os.environ.get("SECRET_KEY") #"django-insecure-pd=#xgfzzz24!+*r_!5_88s3e0i8tgnuvakdr=&f@kee#x5o3a"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = bool(os.environ.get("DEBUG", default=0)) #True

ALLOWED_HOSTS = os.environ.get("DJANGO_ALLOWED_HOSTS").split(" ") #["0.0.0.0","localhost","127.0.0.1"]
